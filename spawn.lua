...
--	neighbor = {"darkage:slate"}
	...
	mobs:spawn({name = "dmobs:treeman", nodes = {"group:leaves","moognu:moognu"}, neighbor = {},
		min_light = 0, max_light = 30, interval = 300, chance = 4, active_object_count = 2, min_height = 0, max_height = 2000})
